...
def QueryFunc(collection, commentcollection, i, insertnum, mm, numtopicids):
  count = 0
  while count < insertnum:
    ...
    commentcollection.find_one({"topic_id":rand_topicid})
    count += 1
...
if __name__  == '__main__':
  ...
  commentcollection = client.commentdbsharded.shardtest1
  ...
  for i in range(threadnum):
    ...
    curthread = Process(target=QueryFunc, args=(collection, commentcollection, i, insertnum, mm, numtopicids))
    curthread.start()
