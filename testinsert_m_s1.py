...
def InsertFunc(collection, i, insertnum, mm, fsize):
  ...
  while count < insertnum:
    ...
    try:
      ...
      print "auto reconnect", count
      time.sleep(2)
      continue
    except pymongo.errors.OperationFailure:
      print "operation failure", count
      continue
    count += 1
...
#  numtopicids = fsize/24
  ...
  #client = MongoClient("172.18.4.241:27017,172.18.4.240:27017")
  client = MongoClient("172.18.18.14:37017", replicaset="rs0")
  db = client.topicdbi3
